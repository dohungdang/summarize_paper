...
- Khi đó ta kết nối với Backend đã được chạy trên local bằng 2 API http://127.0.0.1:8000/upload_paper và http://127.0.0.1:8000/summarize_text để thực hiện xử lý tóm tắt văn bản upload_paper là xử lý file pdf và summarize_text là để xủ lý văn bản
